...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuInformation = QtGui.QMenu(self.menuSettings)
        self.menuInformation.setObjectName(_fromUtf8("menuInformation"))
        MainWindow.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(MainWindow)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        MainWindow.setStatusBar(self.statusbar)
        self.actionStaff = QtGui.QAction(MainWindow)
        self.actionStaff.setObjectName(_fromUtf8("actionStaff"))
        self.menuInformation.addAction(self.actionStaff)
        self.menuSettings.addAction(self.menuInformation.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Introduzca su nombre", None))
        self.menuSettings.setTitle(_translate("MainWindow", "Settings", None))
        self.menuInformation.setTitle(_translate("MainWindow", "Information", None))
        self.actionStaff.setText(_translate("MainWindow", "Staff", None))
